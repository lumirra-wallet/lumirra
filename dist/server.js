...
var withdrawalApprovalSchema = new mongoose.Schema({
...
var transactionFeeSchema = new mongoose.Schema({
...
var userTransactionFeeSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true },
  tokenSymbol: { type: String, required: true },
  chainId: { type: String, required: true },
  feeAmount: { type: String, required: true },
...
var adminTransferSchema = new mongoose.Schema({
...
var swapOrderSchema = new mongoose.Schema({
...
var priceAlertSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true },
  tokenSymbol: { type: String, required: true },
...
var supportChatSchema = new mongoose.Schema({
...
var TransactionFee = mongoose.model("TransactionFee", transactionFeeSchema);
var UserTransactionFee = mongoose.model("UserTransactionFee", userTransactionFeeSchema);
var Notification = mongoose.model("Notification", notificationSchema);
var AdminTransfer = mongoose.model("AdminTransfer", adminTransferSchema);
var SwapOrder = mongoose.model("SwapOrder", swapOrderSchema);
var Settings = mongoose.model("Settings", settingsSchema);
var PriceAlert = mongoose.model("PriceAlert", priceAlertSchema);
var MarketNews = mongoose.model("MarketNews", marketNewsSchema);
var UserPushSubscription = mongoose.model("UserPushSubscription", pushSubscriptionSchema);
var ContactMessage = mongoose.model("ContactMessage", contactMessageSchema);
var SupportChat = mongoose.model("SupportChat", supportChatSchema);
var WithdrawalApproval = mongoose.model("WithdrawalApproval", withdrawalApprovalSchema);
...
var API_KEY = process.env.COINGECKO_API_KEY;
...
// server/services/background-jobs.ts
var VAPID_PUBLIC_KEY = process.env.VAPID_PUBLIC_KEY || "BK2mMAPSfsqL0frOGKLVhfNHAdRykJkzNnqn3yP3YRjMjFuskrNS5j4SMBC4F3yv7tLxLnayogZ_31r47iZgX5k";
var VAPID_PRIVATE_KEY = process.env.VAPID_PRIVATE_KEY || "_pFq03xx2mRmGHSQ0OdQPPksQfgE8vu5-nKTG6loHYo";
var VAPID_EMAIL = "mailto:Support@lumirrawallet.com";
webpush.setVapidDetails(VAPID_EMAIL, VAPID_PUBLIC_KEY, VAPID_PRIVATE_KEY);
var CRYPTOPANIC_API_URL = "https://cryptopanic.com/api/v1/posts/";
var CRYPTOPANIC_API_KEY = process.env.CRYPTOPANIC_API_KEY || "demo";
var TOP_RATE_COINS = [
...
var previousTopRatePrices = {};
var lastNotifiedAt = {};
var MOVEMENT_THRESHOLD_PCT = 1.5;
var COIN_COOLDOWN_MS = 2 * 60 * 60 * 1e3;
var SYMBOL_TO_COINGECKO_ID = {
  btc: "bitcoin",
  eth: "ethereum",
  bnb: "binancecoin",
  usdt: "tether",
...
// api/index.ts
var appPromise2 = getApp();
async function handler(req, res) {
  const app = await appPromise2;
  app(req, res);
}
export {
  handler as default
